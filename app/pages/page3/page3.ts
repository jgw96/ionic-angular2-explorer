import {Page, Alert, NavController, ViewController, Modal} from 'ionic-framework/ionic';
...
export class Page3 {
    ...
    constructor(http: Http, nav: NavController) {
        ...
        this.http.get("https://api.github.com/repos/driftyco/ionic")
            .map(res => res.json())
            .subscribe(data => {
                console.log(data);
        ...
        this.http.get("https://api.github.com/search/code?q=directive+in:file+language:js+repo:driftyco/ionic", { headers })
            .map(res => res.json())
            .subscribe(data => {
                this.loading = false;
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: data => {
                        ...
                        let term = data.term;
                        this.http.get(`https://api.github.com/search/code?q=${term}+in:file+language:js+repo:driftyco/ionic`, { headers })
                            .map(res => res.json())
                            .subscribe(data => {
                                this.loading = false;
                                this.codes = data.items;
    ...
    getContribs() {
        this.http.get("https://api.github.com/repos/driftyco/ionic/stats/contributors")
            .map(res => res.json())
            .subscribe(data => {
                console.log(data);
...
class StarsModal {
    ...
    constructor(public viewCtrl: ViewController, public http: Http) {
        this.viewCtrl = viewCtrl;
        this.http.get("https://api.github.com/repos/driftyco/ionic/stargazers")
            .map(res => res.json())
            .subscribe(data => {
                console.log(data);
                this.stars = data;
